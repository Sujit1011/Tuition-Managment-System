...
$conn = mysqli_connect('localhost', 'root', '','tutioncenter');  
                  ...
                  $qry = 'SELECT fac_id,fac_fname,fac_mname,fac_lname,fac_gender,fac_email,fac_phonenum  
                          FROM faculty 
                          WHERE fac_id = ' . $fac_id; 
                  /*Create query*/  
                
                  $qry_2 = 'SELECT present,total 
                          FROM facattendance 
                          WHERE fac_id = ' . $fac_id; 
                  /*Execute query*/ 
...
<!--				  <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>-->
			  ...
			  <div class="col">
				...
				<div class="small-box bg-success">
				  <div class="inner">
					<h3><?php echo $row[1].$row[2].$row[3] ?></h3>
