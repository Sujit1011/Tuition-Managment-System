                    ...
                    <?php   
                      ...
                      if (mysqli_connect_errno())
                      {
                        echo "Failed to connect to MySQL: " . mysqli_connect_error();
                                            ...
                                            /*Create query*/ 
                      $qry = 'SELECT faculty.fac_id, fac_fname, facattendance.present, total-present, total, (present/total)*100 
                      FROM faculty,facattendance 
                      WHERE faculty.fac_id = facattendance.fac_id';  
